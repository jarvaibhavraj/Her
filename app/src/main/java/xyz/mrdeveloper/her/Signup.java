...
public class Signup extends AppCompatActivity implements
    ...
    LinearLayout input, verification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input = (LinearLayout) findViewById(R.id.phone_auth_fields);
        verification = (LinearLayout) findViewById(R.id.phone_verification);
    ...
    public void AddUserToFirebase() {
        ...
        mFirebaseDatabase.child(phoneNumber).child("PhoneNumber").setValue(phoneNumber);
        mFirebaseDatabase.child(phoneNumber).child("AmIAlerted").setValue(false);
    }
