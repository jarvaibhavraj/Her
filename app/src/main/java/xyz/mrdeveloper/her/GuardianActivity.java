...
public class GuardianActivity extends FragmentActivity implements
        LocationListener,
...
//    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dest = new LatLng(30.409222, 77.969290);
...
//        textSOS.setText((i) + " PROTECTORS have been notified. They will reach you shortly.\nDon't panic. Move to a safe location.");
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED) {
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, GuardianActivity.this);
        }
    }
...
//        locations.add(3, new LatLng(29.709222, 78.969290));
        ...
        if (!hasAlreadyFocused) {
            mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(currentUserPosition, 15));
            hasAlreadyFocused = true;
//            NotifyUsers();

            String url = getUrl(currentUserPosition, new LatLng(30.409222, 77.969290));
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(GuardianActivity.this,
